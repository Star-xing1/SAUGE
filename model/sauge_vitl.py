"""
The architecture of basic SAUGE (vitl version).
"""
import torch
...
class STN(nn.Module):
    def __init__(self, in_channels,LayerNorm_type="WithBias"):
        ...
        self.proj_embd = nn.Sequential(
            nn.Conv2d(192, in_channels // 16, kernel_size=3, padding=1),
            LayerNorm(in_channels // 16, LayerNorm_type),
            nn.GELU(),
            nn.Conv2d(in_channels // 16, 48, kernel_size=3, padding=1),
